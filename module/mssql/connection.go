...
func (connection *Connection) Handshake(flags *module.MSSQL) (EncryptMode, error) {
	...
	config := (*zgrab2.TLSFlags)(&flags.TLSFlags)
	tlsClient, err := config.GetTLSConnection(connection.tdsConn)
	if err != nil {
		return mode, err
	}
